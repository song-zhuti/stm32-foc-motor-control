/**
  ...
  *              - To use or not the peripheralùs drivers in application code(i.e. 
  *                code will be based on direct access to peripheralùs registers 
  ...
  *           - Macros to access peripheralùs registers hardware
  *
  ******************************************************************************
  * @attention
  *
